...
namespace Bambo
{
	...
	public:
		...
		static SPtr<VertexBufferObject> CreateVertexBufferObject(const void* data, uint32 size);
		static SPtr<VertexBufferObject> CreateVertexBufferObject(uint32 size);
	};
}